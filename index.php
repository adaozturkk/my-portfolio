...
<html lang="en">
  <head>
    ...
    <title>Ada Öztürk | Portfolio</title>
    <link rel="stylesheet" href="style.css" />
  </head>
  <body>
    <nav class="navbar">
      <div class="logo">Ada Öztürk</div>
      <ul class="nav-links">
    ...
    <main>
      <section id="about" class="hero">
        <h1>Hi, I'm Ada.</h1>
        <h2 class="gradient-text">Web Developer</h2>
        <p>
          I build web applications specializing in C#, ASP.NET Core, and SQL
          databases, while crafting clean, responsive interfaces with React.
        </p>
      </section>
      ...
      <section id="skills">
        ...
        <div class="skills-grid">
          ...
          <div class="card skill-card">
            ...
            <p>MySQL, SQL Server, Git, GitHub</p>
          </div>
        </div>
      </section>
